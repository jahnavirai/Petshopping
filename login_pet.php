...
if(isset($_POST['clickk']))
{
	...
	if(isset($_POST['login']))
	{
		...
		if($a==1)
		{
		 ...
		 if($b==1)
		{
			$userlogin1=$con->prepare("select * from admin_info where admin_username='admin' and password='admin' ");
			
			$userlogin1->execute();
			
			$row1_check=$userlogin1->rowCount();
...
body{	
	...
	{
		margin:0 auto;
		background-image:url("pet11.jpg");
		background-repeat:no-repeat;
		background-size: 100% 680px;
