...
<?php
	...
	echo"<h1 style='color:#fff;background:#535252;text-align:center;line-height:50px;height:50px;'>Your Address</h1>";
		echo"<div id='box1'>";
...
?>
					<div id="show">
						<h1 style="color:#fff;background:#535252;text-align:center;line-height:50px;height:50px;">Your orders</h1>
