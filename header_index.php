...
<style>
*{margin:0%;}
#header{background:#292a2f;width:100%;height:150px;text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;}
...
<body>
<div id="header">
	<a href="index.php"><img  style="border:1px solid #000;"></a>
	...
	if(isset($_COOKIE['usernameget']))
				...
				<form method="post">
		<input type="text" name="search1" required style="margin-left:300px;margin-top:30px;width:300px;height:40px;border-radius:4px;border:1px solid #292a2f;">
		<input type="submit" name="search" value="Search" style="position:relative;margin-left:610px;margin-top:-40px;width:70px;height:40px;border-radius:4px;border:1px solid #292a2f;background:#fff;color:#3a3a3c;">
	</form>
</div>
</body>
</html>
